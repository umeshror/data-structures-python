...
Note, this is a more advanced problem than the previous two! It aso has a lot o
f variation possibilities and we're ignoring strict requirements here.
...
\string in a way in which words can be made from the list of words. You can
